...
namespace sapra.Migrations
{
    ...
    [Migration("20201127054750_Database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sapra.Models.Permission", b =>
                {
            ...
            modelBuilder.Entity("sapra.Models.RolePermission", b =>
                {
                    b.Property<int>("RoleId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("sapra.Models.RolePermission", b =>
                {
                    b.HasOne("sapra.Models.Permission", "Permission")
            ...
            modelBuilder.Entity("sapra.Models.User", b =>
                {
                    b.HasOne("sapra.Models.Role", "UserRole")
                        .WithMany("Users")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
